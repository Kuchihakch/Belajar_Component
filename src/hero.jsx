...
export default function Body(){
    return(
        <section className="grid md:grid-cols-2 place-content-center place-items-center w-full min-h-screen max-sm:gap-y-10 sm:gap-y-5 gap-x-10 font-[Poppins] p-20">
            <div className="image grid grid-cols-4 grid-rows-2 w-100 max-sm:w-80 gap-2">
            ...
            <div className="text-content text-black px-20 flex flex-col gap-3 min-w-100 w-full">

             <p className="font-bold text-4xl text-blue-600 text-justify">Hello, I am FelienZ!</p>
             <p>I Just start my web development journey in React-App.</p>
             <p>I'm a Unsri Student's that passionate in Web Development, I Explore Either Front-End and Back-End Technology.</p>
             <div className="info self-end flex justify-start max-sm:justify-center w-full items-center gap-3">
                ...
                <div className="button flex w-full justify-end gap-2">
